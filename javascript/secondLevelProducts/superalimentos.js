$(document).ready(function() {
  ...
  showCategories([
    ...
    {imageName: '3', imageType: 'jpg', price: '100.00', description: 'Nombre del art&iacute;culo', buttonDescription: 'M&aacute;s informaci&oacute;n'},
    {imageName: '4', imageType: 'jpg', price: '100.00', description: 'Nombre del art&iacute;culo', buttonDescription: 'M&aacute;s informaci&oacute;n'},
    {imageName: '1', imageType: 'jpg', price: '100.00', description: 'Nombre del art&iacute;culo', buttonDescription: 'M&aacute;s informaci&oacute;n'},
    {imageName: '2', imageType: 'jpg', price: '100.00', description: 'Nombre del art&iacute;culo', buttonDescription: 'M&aacute;s informaci&oacute;n'},
    {imageName: '3', imageType: 'jpg', price: '100.00', description: 'Nombre del art&iacute;culo', buttonDescription: 'M&aacute;s informaci&oacute;n'},
    {imageName: '4', imageType: 'jpg', price: '100.00', description: 'Nombre del art&iacute;culo', buttonDescription: 'M&aacute;s informaci&oacute;n'},
...
function showCategories(contentCols, cnf){
  ...
  $('#showSuperalimentos').html(htmlContent)
}
...
function addDataCol(data){
  var columnImage = '' +
    '<div class="column4_space textCenter move bgWhite borderRounded4">' +
      '<br/>' +
      '<img src=\"images/superalimentos/' + data.imageName + '.' + data.imageType + '\" width=\"90%\"/>' +
      '<br/><br/>' +
